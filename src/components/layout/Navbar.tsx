...
export const Navbar: React.FC = () => {
  return (
    <header className="h-20 border-b border-white/5 flex items-center justify-between px-8 bg-[#0a0a0f]/40 backdrop-blur-md z-20">
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="flex items-center gap-3 p-1.5 pr-4 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/[0.08] transition-all group">
